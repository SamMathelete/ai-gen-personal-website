...
\begin{center}
    ...
    \href{mailto:sambitmi@usc.edu}{\faEnvelope \ sambitmi@usc.edu}
\end{center}

%-----------RESEARCH FOCUS-----------------
\section{Research Focus}
\small{
Causal inference and probabilistic graphical models, with emphasis on scalable continuous optimization methods for causal discovery in high-dimensional data. Focused on reliable structure learning under distribution shift, with applications to fraud detection and decision systems.
}
\vspace{-8pt}
...
\section{Education}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      \resumeItem{\textbf{Coursework Taken:} Probability Theory (EE 503 - Fall 2025, Grade: A) , Linear Algebra (EE 510 - Fall 2025, Grade: A), Supervised Machine Learning (EE 559 - Spring 2026, Ongoing), Inference \& Estimation Theory (EE 563 - Spring 2026, Ongoing).}
